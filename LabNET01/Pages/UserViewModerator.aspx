<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserViewModerator.aspx.cs" Inherits="Projekt.Pages.UserViewModerator" %>
...
<body>
    <form id="form1" runat="server">
        <div id="user_moderator" runat="server">
            <div>
                ...
                <div>
                    ...
                    <div id="update_emai_box" runat="server">
                        ...
                        <br />
                        &nbsp;<asp:Button ID="Button1" Text="UPDATE E-MAIL" runat="server" OnClick="Update_Email_Click" Style="margin-left: 0px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="update_email" runat="server" Height="22px"></asp:TextBox>
                    </div>
